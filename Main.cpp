...
void testAddFunction() {
    ...
    myList.add(1, 0); // Add at position 0
    myList.add(2, 1); // Add at position 1
    myList.add(3, 1); // Add at position 1
...
void testRemoveFunction() {
    ...
    myList.add(1, 0); // myList: 1
    myList.add(2, 1); // myList: 1 2
    myList.add(3, 1); // myList: 1 3 2
